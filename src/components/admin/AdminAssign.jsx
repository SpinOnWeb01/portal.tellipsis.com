...
function AdminAssign({ colorThem }) {
  ...
  const columns = [
    ...
    },
    {
      ...
      //   const formattedDetails = params.value
      //     ?.replace(/^{|}$/g, "")
      //     .replace(/,/g, ", "); // Add space after each comma;
      //   return (
      //     <div
      //       style={{
      //         overflowX: "auto", // Enable horizontal scroll
      //         whiteSpace: "nowrap", // Prevent wrapping of text
      //         maxWidth: "100%", // Restrict to cell width
      //       }}
      //     >
      //       {formattedDetails}
      //     </div>
