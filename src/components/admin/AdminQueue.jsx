...
function AdminQueue({ colorThem }) {
  ...
  const [ringInUse, setRingInUse] = useState("no");
  ...
  const [maximumWaitTime, setMaximumWaitTime]= useState("");
  ...
  const handleButtonClick = useCallback((row) => {
    ...
    setMaximumWaitTime(row.max_wait_time);
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(
      createAdminQueue(data, handleClose, setResponse)
    );
  }
  };
...
<TextField
                                      ...
                                      onChange={(e) => {
                                        ...
                                        setMaximumWaitTime(e.target.value);
                                      }}
                                      // inputProps={{
                                      //   inputMode: "numeric",
                                      //   // pattern: '[0-9]*',
